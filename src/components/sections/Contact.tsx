            ...
            <div className="space-y-5">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-white font-semibold text-sm group-hover:text-cyan-200 transition-colors">
                   Business Intelligence Lab 3rd Floor Room # 309, Lotus Paradise Centre, Karangalpady, Mangalore – 575002, Karnataka, India
                  </p>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-white font-semibold text-sm group-hover:text-cyan-200 transition-colors">Monday to Saturday, 9:00 AM – 6:00 PM IST</p>
                </div>
              </a>
